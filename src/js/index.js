...
OBEJTIVO 1 - quando clicar no botão do personagem na lista, marcar o botão como selecionado
...
botoes.forEach((botao, indice) => {
   botao.addEventListener("click", () => {
     ...
     //passo 2 - adicionar a classe "selecionado" no botão que o usuário clicou
       ...
       //passo 3 - verifivar se já exista um personagem selecionado, se sim, devemos remover a seleção dele
